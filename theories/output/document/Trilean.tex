...
\isatagproof
\isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}metis\ {\isacharparenleft}no{\isacharunderscore}types{\isacharcomma}\ hide{\isacharunderscore}lams{\isacharparenright}\ add{\isachardot}commute\ invalid{\isacharunderscore}maybe{\isacharunderscore}and\ maybe{\isacharunderscore}and{\isacharunderscore}idempotent\ maybe{\isacharunderscore}and{\isacharunderscore}one\ maybe{\isacharunderscore}not{\isachardot}elims\ maybe{\isacharunderscore}not{\isachardot}simps{\isacharparenleft}{\isadigit{1}}{\isacharparenright}\ maybe{\isacharunderscore}not{\isachardot}simps{\isacharparenleft}{\isadigit{3}}{\isacharparenright}\ maybe{\isacharunderscore}not{\isacharunderscore}invalid\ maybe{\isacharunderscore}or{\isacharunderscore}zero\ plus{\isacharunderscore}trilean{\isachardot}simps{\isacharparenleft}{\isadigit{1}}{\isacharparenright}\ plus{\isacharunderscore}trilean{\isachardot}simps{\isacharparenleft}{\isadigit{4}}{\isacharparenright}\ times{\isacharunderscore}trilean{\isachardot}simps{\isacharparenleft}{\isadigit{1}}{\isacharparenright}\ times{\isacharunderscore}trilean{\isacharunderscore}commutative\ trilean{\isachardot}exhaust\ trilean{\isachardot}simps{\isacharparenleft}{\isadigit{6}}{\isacharparenright}{\isacharparenright}%
\endisatagproof
{\isafoldproof}%
%
\isadelimproof
...
\isatagproof
\isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}metis\ de{\isacharunderscore}morgans{\isacharunderscore}{\isadigit{1}}\ maybe{\isacharunderscore}double{\isacharunderscore}negation{\isacharparenright}%
\endisatagproof
{\isafoldproof}%
%
\isadelimproof
...
\isatagproof
\isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}metis\ {\isacharparenleft}no{\isacharunderscore}types{\isacharcomma}\ lifting{\isacharparenright}\ maybe{\isacharunderscore}not{\isachardot}cases\ trilean{\isachardot}distinct{\isacharparenleft}{\isadigit{1}}{\isacharparenright}\ trilean{\isachardot}distinct{\isacharparenleft}{\isadigit{3}}{\isacharparenright}{\isacharparenright}%
\endisatagproof
{\isafoldproof}%
%
\isadelimproof
