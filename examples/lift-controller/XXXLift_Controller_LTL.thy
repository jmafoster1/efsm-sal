...
theory XXXLift_Controller_LTL
imports "EFSM.EFSM" Lift_Controller
begin
...
lemma "lift_controller_ltl = lift"
  apply (simp add: lift_controller_ltl_def lift_def transitions Lift_Controller.transitions)
  by auto
